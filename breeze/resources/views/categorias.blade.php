    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-4 gap-2 w-1/2 mx-auto">
                        ...
                        <span class="w-1/4 mx-2">
                            <a href="/categoria/create" class="text-yellow-600 hover:text-yellow-500
            ...
            @foreach( $categorias as $categoria )
                            ...
                            <div class="border-b border-gray-100 p-3 flex items-center justify-center">
                                                <span class="w-1/4 mx-2">
                            <a href="/categoria/edit/{{ $categoria->idCategoria }}" class="text-yellow-600 hover:text-yellow-500
                                        bg-gray-50 hover:bg-white px-5 py-1
                                        border border-gray-300 rounded
                                        ">Modificar</a>
                        </span>
